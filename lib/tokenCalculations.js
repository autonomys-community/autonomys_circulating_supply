...
export async function calculateCirculatingSupply() {
  try {
    ...
    const [consensusSupply, domainSupply, totalStaked, guardiansOfGrowthBalance, nearTermTreasuryBalance, subspaceFoundationOperationsBalance, ambassadorsWalletBalance, wrappedAi3TotalSupply, hedgeySfAdminNativeAi3Balance, sfAutoEvmBalance] = await Promise.all([
