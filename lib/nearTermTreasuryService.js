...
const DEFAULT_NEAR_TERM_TREASURY_ADDRESS = 'sudqduciRx3fZcNRbW1mmmBAntuZLkwhcXyVctsGJyrjRTPaA';
 ...
 */
export async function getNearTermTreasuryWalletBalance(
  networkId = 'mainnet',
  address = DEFAULT_NEAR_TERM_TREASURY_ADDRESS
) {
  try {
