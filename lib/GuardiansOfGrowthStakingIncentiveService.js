 ...
 */
export async function getGuardiansOfGrowthStakingIncentiveFreeBalance(
  networkId = 'mainnet',
  ...
  try {
    ...
    try {
      ...
      const freeAI3 = Number(parseTokenAmount((free ?? 0).toString())).toFixed(4);
      return Math.round(parseFloat(freeAI3));
